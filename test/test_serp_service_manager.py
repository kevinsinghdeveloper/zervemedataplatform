...
from data_platform.connectors.api_services.SerpServiceManager import SerpServiceManager
...
class TestSerpServiceManager(unittest.TestCase):
    ...
    @patch('data_platform.connectors.api_services.SerpServiceManager.requests.get')
    @patch('data_platform.connectors.api_services.SerpServiceManager.Utility')
    ...
    def test_utility_clean_and_convert_called(self, mock_utility):
        ...
        with patch('data_platform.connectors.api_services.SerpServiceManager.requests.get') as mock_get:
            mock_response = Mock()
            mock_response.json.return_value = {
                "shopping_results": [{
                    "title": "Test",
