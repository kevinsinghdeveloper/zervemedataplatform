...
class TestSparkCloudConnector(unittest.TestCase):
    ...
    @patch('data_platform.connectors.cloud_storage_connectors.SparkCloudConnector.SparkSession')
    ...
    @patch('data_platform.connectors.cloud_storage_connectors.SparkCloudConnector.Utility')
    @patch('data_platform.connectors.cloud_storage_connectors.SparkCloudConnector.SparkSession')
